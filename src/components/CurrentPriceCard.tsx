...
function CurrentPriceCard({ currentPrice, previousPrice, nextPrice, medianPrice, includeVat }: CurrentPriceCardProps) {
    ...
    const glowClass = isCheap ? 'bg-green-500/10 group-hover:bg-green-500/20' : 'bg-red-500/10 group-hover:bg-red-500/20';
    ...
    return (
        <div className={`p-4 lg:p-6 rounded-2xl bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 border ${borderColor} shadow-xl ${shadowColor} backdrop-blur-2xl relative overflow-hidden group hover:-translate-y-1 transition-all duration-500 h-full flex flex-col justify-center`}>
            ...
            <div className={`absolute -top-10 -right-10 w-32 h-32 ${glowClass} rounded-full blur-3xl transition-all duration-700`}></div>
